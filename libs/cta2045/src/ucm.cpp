...
UCM::UCM() { max_payload_ = cea2045::MaxPayloadLengthCode::LENGTH2; }
...
MaxPayloadLengthCode UCM::getMaxPayload() { return max_payload_; }
...
void UCM::processSetTemperatureOffsetResponse(
    cea2045IntermediateResponse *message) {
  // TODO
}

void UCM::processGetTemperatureOffsetResponse(
...
void UCM::processTerminateCyclingResponse(
    cea2045IntermediateResponse *message) {
  // TODO
}

void UCM::processGetPresentTemperatureResponse(
...
void UCM::processIncompleteMessage(const unsigned char *buffer,
