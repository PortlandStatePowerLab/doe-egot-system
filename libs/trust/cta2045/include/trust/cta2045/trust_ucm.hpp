...
public:
  cea2045UCM(const https::Context &dtm);
  ~cea2045UCM();

  bool isMessageTypeSupported(cea2045::MessageTypeCode type_code) override;
  cea2045::MaxPayloadLengthCode getMaxPayload() override;
  void
  processMaxPayloadResponse(cea2045::MaxPayloadLengthCode payload) override;
  void processDeviceInfoResponse(
      cea2045::cea2045DeviceInfoResponse *message) override;
  void
  processCommodityResponse(cea2045::cea2045CommodityResponse *message) override;
  void processSetEnergyPriceResponse(
      cea2045::cea2045IntermediateResponse *message) override;
  void processSetTemperatureOffsetResponse(
      cea2045::cea2045IntermediateResponse *message) override;
  void processGetTemperatureOffsetResponse(
      cea2045::cea2045GetTemperateOffsetResponse *message) override;
  void processSetSetpointsResponse(
      cea2045::cea2045IntermediateResponse *message) override;
  void processGetSetpointsResponse(
      cea2045::cea2045GetSetpointsResponse1 *message) override;
  void processGetSetpointsResponse(
      cea2045::cea2045GetSetpointsResponse2 *message) override;
  void processStartCyclingResponse(
      cea2045::cea2045IntermediateResponse *message) override;
  void processTerminateCyclingResponse(
      cea2045::cea2045IntermediateResponse *message) override;
  void processGetPresentTemperatureResponse(
      cea2045::cea2045GetPresentTemperatureResponse *message) override;
  void processGetUTCTimeResponse(
      cea2045::cea2045GetUTCTimeResponse *message) override;
  void processAckReceived(cea2045::MessageCode code) override;
  void processNakReceived(cea2045::LinkLayerNakCode nak,
                          cea2045::MessageCode code) override;
  ...
  void processIncompleteMessage(const unsigned char *buffer,
                                unsigned int byte_count) override;
