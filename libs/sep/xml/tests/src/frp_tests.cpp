...
protected:
  void SetUp() override {
    ...
    xml_str = psu::utilities::readFile(g_program_path +
                                       "/sep_xml/FlowReservationResponse.xml");
    list_xml_str = psu::utilities::readFile(
        g_program_path + "/sep_xml/FlowReservationResponseList.xml");
  }
...
TEST_F(TestFlowReservationResponseXML, CheckAdapterSubscribableMaxInclusive) {
  ...
  pt.put("FlowReservationResponse.mRID", 0x0FB7);
  ...
  pt.put("FlowReservationResponse.subject", 0x0FB7);
...
TEST_F(TestFlowReservationResponseXML,
       CheckAdapterResponseRequiredMaxInclusive) {
  boost::property_tree::ptree pt;
...
TEST_F(TestFlowReservationResponseXML,
       CheckAdapterResponseCurrentStatusMaxInclusive) {
  boost::property_tree::ptree pt;
  pt.put("FlowReservationResponse.<xmlattr>.subscribable", 0);
  pt.put("FlowReservationResponse.<xmlattr>.replyTo", "http://uri1");
  pt.put("FlowReservationResponse.<xmlattr>.responseRequired", "00");
...
TEST_F(TestFlowReservationResponseXML,
       CheckAdapterResponseCurrentStatusMinInclusive) {
  boost::property_tree::ptree pt;
  pt.put("FlowReservationResponse.<xmlattr>.subscribable", 0);
  pt.put("FlowReservationResponse.<xmlattr>.replyTo", "http://uri1");
  pt.put("FlowReservationResponse.<xmlattr>.responseRequired", "00");
