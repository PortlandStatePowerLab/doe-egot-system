...
{   
    ...
    EXPECT_EQ(edev->flow_reservation_request_list_link.value().href, "http://uri1");
    EXPECT_EQ(edev->flow_reservation_request_list_link.value().all, 0);
    EXPECT_EQ(edev->flow_reservation_response_list_link.value().href, "http://uri1");
    EXPECT_EQ(edev->flow_reservation_response_list_link.value().all, 0);
    EXPECT_EQ(edev->function_set_assignments_list_link.value().href, "http://uri1");
