...
/// Implementers and consumers can use this attribute to prioritize operations
/// of their HAN devices (e.g., PEV charging during times of high availability
/// of renewable electricity resources).
///
